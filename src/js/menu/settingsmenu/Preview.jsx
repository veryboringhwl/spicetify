...
const PlaylistIcon = () => (
  <svg viewBox="0 0 16 16" width="50%" height="50%" fill="currentColor" style={{ opacity: 0.5 }}>
...
const TrackIcon = () => (
  <svg viewBox="0 0 24 24" width="50%" height="50%" fill="currentColor" style={{ opacity: 0.5 }}>
    ...
    <div className="navbar">
      <div className="navbar__item navbar__item--left">
        ...
        <div className="navbar__item-button">
          <svg viewBox={"0 0 76.465 68.262"} width={16} height={16} fill="currentcolor">
      ...
      <div className="navbar__item navbar__item--right">
        ...
        <div className="navbar__item-windows-controls">
          <div className="navbar__item-windows-controls-btn" onClick={(e) => onMinimize(id, e)}>
            <svg width="12" height="12">
              <line x1="1" y1="6" x2="11" y2="6" stroke="currentColor" strokeWidth=".9" />
            </svg>
          </div>
          <div className="navbar__item-windows-controls-btn" onClick={(e) => onMaximize(id, e)}>
            <svg width="12" height="12" fill="none" stroke="currentColor" strokeWidth=".9">
              <rect x="1.5" y="3.5" width="7" height="7" />
              <polyline points="3.5,3.5 3.5,1.5 10.5,1.5 10.5,8.5 8.5,8.5" />
            </svg>
          </div>
          <div className="navbar__item-windows-controls-btn" onClick={(e) => onClose(id, e)}>
            <svg width="12" height="12">
...
const Sidebar = () => {
  return (
    <div className="sidebar">
      ...
      <SidebarPlaylistItem name={"Playlist 1"} info={"Playlist.Username"} />
      <SidebarPlaylistItem name={"Playlist 2"} info={"Playlist.Username"} />
      <SidebarPlaylistItem name={"Playlist 3"} info={"Playlist.Username"} />
      <SidebarPlaylistItem name={"Playlist 4"} info={"Playlist.Spotify"} />
      <SidebarPlaylistItem name={"Playlist 5"} info={"Playlist.Spotify"} />
      <SidebarPlaylistItem name={"Spotify"} info={"Spotify"} />
    </div>
  );
};
  ...
  return (
    <div className="main-view main-playlist">
      ...
      <div className="main-playlist__tracklist">
        ...
        <PlaylistTrack num={1} title="Track 1" artist="Artist 1" album="Album 1" time="3:45" />
        <PlaylistTrack num={2} title="Track 2" artist="Artist 1" album="Album 1" time="4:10" />
        <PlaylistTrack num={3} title="Track 3" artist="Artist 2" album="Album 2" time="2:59" />
        <PlaylistTrack num={4} title="Track 4" artist="Artist 2" album="Album 2" time="5:02" />
        <PlaylistTrack num={5} title="Track 5" artist="Artist 3" album="Album 3" time="3:15" />
        <PlaylistTrack num={6} title="Track 6" artist="Artist 3" album="Album 3" time="4:20" />
        <PlaylistTrack num={7} title="Track 7" artist="Artist 3" album="Album 3" time="2:45" />
        <PlaylistTrack num={8} title="Track 8" artist="Artist 4" album="Album 4" time="3:30" />
        <PlaylistTrack num={9} title="Track 9" artist="Artist 5" album="Album 5" time="3:15" />
        <PlaylistTrack num={10} title="Track 10" artist="Artist 6" album="Album 6" time="3:15" />
        <PlaylistTrack num={11} title="Track 11" artist="Artist 6" album="Album 6" time="2:45" />
        <PlaylistTrack num={12} title="Track 12" artist="Artist 7" album="Album 7" time="3:30" />
      </div>
    </div>
  );
};
