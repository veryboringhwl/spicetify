...
(function theme() {
  ...
  const updateCSS = () => {
	...
	const options = [
    { name: "hidetracklistnum", desc: "Hide tracklist numbers:", defaultValue: true },
    { name: "hidenowplayview", desc: "Hide now playing view:", defaultValue: false },
    { name: "switchlayout", desc: "Makes left sidebar in front of npb:", defaultValue: true },
    { name: "newlayout", desc: "Gives the new layout in npb:", defaultValue: false },
    { name: "horizontalnav", desc: "Makes navlinks horizontal:", defaultValue: false },
    { name: "transplaypause", desc: "Transparent play pause button:", defaultValue: true },
    { name: "npvlargerlyrics", desc: "Now playing view has lyrics only:", defaultValue: false },
	];
	...
	content.append(createButton("resetbutton", "Reset", resetOptions));
	content.append(createButton("savebutton", "Save", saveOptions));
