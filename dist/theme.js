(async function() {
  ...
  var ColourScheme = async (scheme) => {
    if (scheme === "default") {
      let schemeTag2 = document.querySelector("style.customColourScheme");
      schemeTag2?.remove();
      return;
    }
    ...
    const injectStr = Object.entries(colourSchemes[scheme]).reduce((acc, [key, value]) => {
      const rgb = value.length === 3 ? value.split("").map((char) => parseInt(char + char, 16)).join(", ") : value.match(/\w\w/g).map((x) => parseInt(x, 16)).join(", ");
  ...
  var CoverArtBanner = () => {
    ...
    const updateBanner = () => {
      ...
      if (showBanner) {
        ...
        const img = new Image();
        img.src = imageUrl;
        img.onload = () => document.documentElement.style.setProperty(
          "--image",
          `url(${imageUrl})`
        );
      } else {
  ...
  var PopupModal = ({ title = "", content = "", isLarge = true } = {}) => {
  ...
  // src/js/menu/components/InfoButton.jsx
  var InfoButton = import_react2.default.memo(({ name, popupModal }) => {
  ...
  // src/js/menu/components/OptionRow.jsx
  var OptionRow = import_react3.default.memo(({ name, desc, children, popupModal }) => {
    return /* @__PURE__ */ import_react3.default.createElement("div", { className: "themeOptionRow", "data-name": `theme:${name}` }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "themeOptionContent" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "themeOptionDesc" }, desc)), /* @__PURE__ */ import_react3.default.createElement("div", { className: "themeOptionControl" }, /* @__PURE__ */ import_react3.default.createElement(InfoButton_default, { name, popupModal }), children));
  });
  var OptionRow_default = OptionRow;

  // src/js/menu/components/Toggle.jsx
  var Toggle = import_react4.default.memo(
    ({ name, desc, tippy, value, onChange, popupModal }) => {
      ...
      return /* @__PURE__ */ import_react4.default.createElement(OptionRow_default, { name, desc, popupModal }, /* @__PURE__ */ import_react4.default.createElement(
        "button",
        {
        ...
        /* @__PURE__ */ import_react4.default.createElement("span", { className: "toggleWrapper" }, /* @__PURE__ */ import_react4.default.createElement("span", { className: `toggle ${value ? "enabled" : ""}` }))
      ));
    }
  );
  ...
  var Dropdown = import_react5.default.memo(
    ({ name, desc, tippy, value, options: options2, onChange, popupModal }) => {
      ...
      return /* @__PURE__ */ import_react5.default.createElement(OptionRow_default, { name, desc, popupModal }, /* @__PURE__ */ import_react5.default.createElement(
        "select",
        {
        ...
        options2.map(({ value: value2, label }) => /* @__PURE__ */ import_react5.default.createElement("option", { key: value2, value: value2 }, label))
      ));
    }
  );
  ...
  var Input = import_react6.default.memo(
  ...
  // src/js/menu/settingsmenu/OptionType.jsx
  var OptionType = import_react7.default.memo(({ option, value, onChange }) => {
    const Component = { toggle: Toggle_default, dropdown: Dropdown_default, input: Input_default }[option.type];
    return /* @__PURE__ */ import_react7.default.createElement(Component, { ...option, value, onChange });
  });
  ...
  // src/js/menu/modalmenu/WindowsControlModal.jsx
  var WindowsControlModal = import_react8.default.memo(() => {
    ...
    const handleSettingChange = import_react8.default.useCallback((key, value) => {
    ...
    return /* @__PURE__ */ import_react8.default.createElement("div", { className: "themeModalOptions windowsControlSettings" }, windowsControlOptions.map((option) => /* @__PURE__ */ import_react8.default.createElement(
      OptionType_default,
      {
        key: option.name,
        option,
    ...
    )), /* @__PURE__ */ import_react8.default.createElement("div", { className: "buttonContainer" }, /* @__PURE__ */ import_react8.default.createElement(
      "button",
      {
      ...
      "button",
      {
        ...
        onClick: () => saveModal_default(settings, windowsControlOptions)
      },
      "Save"
    )));
  });
  var windowsControlOptions = [
    ...
    },
    {
      ...
      desc: "Set Width",
      defaultVal: "135px",
      run: (value) => document.documentElement.style.setProperty(
        "--windowcontrol-width",
        value
      )
    },
  ...
  var AlbumBannerModal = import_react9.default.memo(() => {
    ...
    const handleSettingChange = import_react9.default.useCallback((key, value) => {
      setSettings((prev) => ({ ...prev, [key.replace("theme:", "")]: value }));
    }, []);
    import_react9.default.useEffect(() => {
      albumBannerOptions.forEach((option) => option.run?.(settings[option.name]));
    }, [settings]);
    return /* @__PURE__ */ import_react9.default.createElement("div", { className: "themeModalOptions albumBannerSettings" }, albumBannerOptions.map((option) => /* @__PURE__ */ import_react9.default.createElement(
      OptionType_default,
      {
        key: option.name,
        option,
    ...
    )), /* @__PURE__ */ import_react9.default.createElement("div", { className: "buttonContainer" }, /* @__PURE__ */ import_react9.default.createElement(
      "button",
      {
        className: "resetButton",
        onClick: () => resetModal_default(albumBannerOptions, setSettings)
      },
      "Reset"
  ...
  var RevealableOption = import_react10.default.memo(({ option, settings, onChange }) => {
    return /* @__PURE__ */ import_react10.default.createElement("div", { className: "themeOptionRevealed" }, option.reveal.map((subOption) => /* @__PURE__ */ import_react10.default.createElement(
      OptionType_default,
      {
        key: subOption.name,
        option: subOption,
  ...
  // src/js/menu/settingsmenu/RenderOptions.jsx
  var RenderOptions = import_react11.default.memo(({ option, settings, onChange }) => {
    const mainValue = settings[`theme:${option.name}`];
    return /* @__PURE__ */ import_react11.default.createElement("div", { className: "themeOptionWrapper" }, /* @__PURE__ */ import_react11.default.createElement("div", { className: "themeOptionMain" }, /* @__PURE__ */ import_react11.default.createElement(
      OptionType_default,
      {
        option,
        value: mainValue,
    ...
    )), mainValue && option.reveal && /* @__PURE__ */ import_react11.default.createElement(
  ...
  var useSettings = () => {
    ...
    const handleSettingChange = import_react12.default.useCallback((key, value) => {
      setSettings((prev) => {
  ...
  function ConfirmDialog({
    ...
    import_react_dom2.default.createRoot(document.createElement("div")).render(/* @__PURE__ */ import_react13.default.createElement(ConfirmDialog2, null));
  }
  ...
  var CategoryCarousel = import_react14.default.memo(({ categories }) => {
    ...
    return /* @__PURE__ */ import_react14.default.createElement("div", { className: "category-carousel-container" }, /* @__PURE__ */ import_react14.default.createElement("div", { className: "category-carousel", ref: carouselRef }, categories.map((category, index) => /* @__PURE__ */ import_react14.default.createElement(
      "button",
      {
        key: category,
  ...
  var Section = import_react15.default.memo(({ name, children }) => {
    return /* @__PURE__ */ import_react15.default.createElement("div", { className: `themeSettingsCategory ${name.toLowerCase()}Container` }, /* @__PURE__ */ import_react15.default.createElement("h2", { className: "categoryTitle" }, name), children);
  });
  var Section_default = Section;

  // src/js/menu/settingsmenu/SettingsMenu.jsx
  var SettingsMenu = import_react16.default.memo(() => {
    const [settings, handleSettingChange, setSettings] = useSettings_default();
    const categories = Object.keys(options_default);
    return /* @__PURE__ */ import_react16.default.createElement("div", { className: "themeContainer" }, /* @__PURE__ */ import_react16.default.createElement(CategoryCarousel_default, { categories }), Object.entries(options_default).map(([category, categoryOptions]) => /* @__PURE__ */ import_react16.default.createElement(Section_default, { key: category, name: category }, categoryOptions.map((option) => /* @__PURE__ */ import_react16.default.createElement(
    ...
    )))), /* @__PURE__ */ import_react16.default.createElement("div", { className: "buttonContainer" }, /* @__PURE__ */ import_react16.default.createElement(
      "button",
      {
        className: "resetButton",
      ...
      "Reset"
    ), /* @__PURE__ */ import_react16.default.createElement("button", { className: "saveButton", onClick: () => saveOptions_default(settings) }, "Save")));
  });
  ...
  var DebugMenu = import_react17.default.memo(() => {
    const [lastVersion, setLastVersion] = import_react17.default.useState("Loading...");
    const [lastUpdated, setLastUpdated] = import_react17.default.useState("Loading...");
    ...
    return /* @__PURE__ */ import_react17.default.createElement("div", { className: "theme-version" }, Object.entries(Info).map(([key, value]) => /* @__PURE__ */ import_react17.default.createElement("p", { key, className: "theme-info-item" }, /* @__PURE__ */ import_react17.default.createElement("span", { className: "theme-info-key encore-text-body-medium-bold" }, key, ":", " "), /* @__PURE__ */ import_react17.default.createElement("span", { className: "theme-info-value" }, value))), /* @__PURE__ */ import_react17.default.createElement("button", { onClick: () => Notification() }, "Special Button"));
  });
  var Notification = () => {
  ...
  var Notification2 = ({
    ...
    Spicetify.Snackbar.enqueueCustomSnackbar(keyPrefix, {
      keyPrefix,
      autoHideDuration,
      children: /* @__PURE__ */ import_react18.default.createElement(
        "div",
        {
  ...
  var Notification_default = Notification2;

  // src/js/utils/Reload.jsx
  var Reload = () => {
  ...
  // src/js/app.jsx
  (async function main() {
    while (!(Spicetify.Platform && Spicetify.Mousetrap && Spicetify.Snackbar.enqueueCustomSnackbar && Spicetify.ReactComponent)) {
    ...
    if (SpotifyVersion < 125e6) {
      Notification_default({
        ...
        message: /* @__PURE__ */ import_react19.default.createElement(import_react19.default.Fragment, null, /* @__PURE__ */ import_react19.default.createElement(
          "svg",
          {
            width: "24",
            height: "24",
        ...
        ), /* @__PURE__ */ import_react19.default.createElement("span", null, "Theme only supports Spotify versions greater than 1.2.50.000"))
      });
    }
    const ContextMenuButton = Spicetify.React.memo(() => /* @__PURE__ */ import_react19.default.createElement(
      Spicetify.ReactComponent.ContextMenu,
      {
        offset: [0, 12],
        trigger: "right-click",
        placement: "top",
        menu: /* @__PURE__ */ import_react19.default.createElement(
          Spicetify.ReactComponent.RemoteConfigProvider,
          {
            configuration: Spicetify.Platform.RemoteConfiguration
          },
          /* @__PURE__ */ import_react19.default.createElement(Spicetify.ReactComponent.Menu, null, /* @__PURE__ */ import_react19.default.createElement(Spicetify.ReactComponent.MenuItem, { onClick: Reload_default, divider: true }, "Reload theme"), /* @__PURE__ */ import_react19.default.createElement(
    ...
    (function mountComponent() {
      ...
      import_react_dom3.default.createRoot(container).render(/* @__PURE__ */ import_react19.default.createElement(ContextMenuButton, null));
    })();
    new Spicetify.ContextMenuV2.ItemSubMenu({
      text: "Theme Options",
      leadingIcon: icons_default.settings,
      items: [
        new Spicetify.ContextMenuV2.Item({
          children: "Reload theme",
          onClick: () => {
            Spicetify.showNotification("Theme reloading...");
            setTimeout(Reload_default, 1e3);
          }
        }),
        new Spicetify.ContextMenuV2.Item({
      ...
      shouldAdd: (_, trigger, target) => {
        ...
        return target?.classList.contains("view-homeShortcutsGrid-shortcut") || targetElement?.getAttribute("aria-label") === "Theme Settings" || target?.classList.contains("main-topBar-buddyFeed") || target?.classList.contains("main-actionButtons") || target?.classList.contains("main-actionButtons > *");
      }
    }).register();
    UpdateZoom_default();
    Mousetrap_default();
